...
> Historical Phase 1 snapshot. It is retained as an audit trail and does not describe the current browser-engine status. See [TOOL_ENGINE_AUDIT.md](TOOL_ENGINE_AUDIT.md) for the authoritative 92-tool matrix and current classifications.
