...
await writeZipFixture('sample.xlsx', [
  ...
  ['xl/worksheets/sheet1.xml', '<?xml version="1.0"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetData><row r="1"><c r="A1" t="inlineStr"><is><t>GXA Toolbox</t></is></c><c r="B1"><v>92</v></c></row></sheetData></worksheet>']
]);
